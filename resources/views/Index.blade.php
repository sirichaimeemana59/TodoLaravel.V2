            ...
            <div class="colorlib-table-cell js-fullheight">
                <div class="row no-gutters">
                    <div class="col-md-12 text-center">
                        ...
                        <ul>
                            {{--<li class="active"><a href="{!! url('/Register') !!}"><span><small>01</small>Home</span></a></li>--}}
                ...
                <div class="container">
                    <div class="row slider-text justify-content-start align-items-center" data-scrollax-parent="true">
                        <div class="col-md-8 col-lg-7 col-sm-12 ftco-animate text mb-4" data-scrollax=" properties: { translateY: '70%' }">
                            ...
                            <h1 class="mb-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Kate Henderson</h1>
...
<div class="modal fade" id="register" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header" style="background-color: #2e3436">
                <h4 class="modal-title" style="color: #bbbfc3">Register Form</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>

            </div>
            <div class="modal-body">
                {!! Form::model(null,array('url' => array('register/form'),'class'=>'form-horizontal','id'=>'form_add')) !!}
...
<div class="modal fade" id="profile" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #2e3436">
                <h4 class="modal-title" style="color: #bbbfc3">Profile</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
