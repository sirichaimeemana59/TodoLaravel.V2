...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        {!! Form::text('name_product',null,array('class'=>'form-control','placeholder'=>'ชื่อหนังสือ','required','readonly')) !!}
    </div>

    <lable class="col-sm-2 control-label">ชื่อผู้แต่ง</lable>
    <div class="col-sm-4">
        {!! Form::text('name_create',null,array('class'=>'form-control','placeholder'=>'ชื่อผู้แต่ง','required','readonly')) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        {!! Form::text('price',null,array('class'=>'form-control','placeholder'=>'ราคา','required','readonly')) !!}
    </div>

    <lable class="col-sm-2 control-label">จำนวน</lable>
    <div class="col-sm-4">
        {!! Form::text('amount',null,array('class'=>'form-control','placeholder'=>'จำนวน','required','readonly')) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        <textarea name="detail" class="form-control" id="" cols="60" rows="10" readonly style="margin: 0px -295.672px 0px 0px; width: 466px; height: 211px;">{!! $product['detail'] !!}</textarea>
    </div>
</div>
